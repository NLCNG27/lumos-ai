...
export default function CSVUploader({
    ...
    const handleFileSelected = (file: File) => {
        ...
        if (file.size > MAX_FILE_SIZE) {
            onUploadError(
                `File size exceeds the ${formatFileSize(MAX_FILE_SIZE)} limit`
            );
            return;
        }
        ...
        >
            ...
            >
                ...
                <p className="text-gray-500 text-sm max-w-md mx-auto">
                    Your CSV file should have headers in the first row. The
                    first column will be used as labels (e.g., dates,
                    categories), and other columns will be visualized as data
                    series.
                </p>
                ...
                <div className="mt-4 flex items-center gap-2 text-amber-400 text-sm">
                    <AlertCircle size={16} />
                    <span>
                        For optimal performance, files should be under 10MB or
                        100,000 rows.
                    </span>
                </div>
            </label>
